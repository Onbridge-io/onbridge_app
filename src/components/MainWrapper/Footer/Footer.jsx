    ...
    <div className={FooterStyled}>
      <div>
        <div className={FooterIcons}>
          <a href="https://medium.com/onbridge" target="_blank">
            <img src="/img/medium.svg" alt="medium" />
          </a>
          <a href="https://twitter.com/onbridge_io" target="_blank">
            <img src="/img/twitter.svg" alt="twitter" />
          </a>
          <a href="https://discord.com/invite/kcNqrgS7" target="_blank">
